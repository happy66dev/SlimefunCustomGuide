...
package cn.rmc.slimefunweaver;

import cn.rmc.slimefunweaver.command.CustomGuideCommand;
...
import cn.rmc.slimefunweaver.web.WebServer;
...
public final class SlimefunWeaver extends JavaPlugin implements SlimefunAddon {

    private static SlimefunWeaver instance;
    ...
    public void onEnable() {
        ...
        if (getConfig().getBoolean("web-editor.enabled", false)) {
            ...
            if (!cn.rmc.slimefunweaver.web.WebSecurity.isSafeBind(bind) && (token == null || token.isEmpty())) {
    ...
    public static SlimefunWeaver getInstance() { return instance; }
