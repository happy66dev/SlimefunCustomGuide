...
package cn.rmc.slimefunweaver.command;
...
public class CustomGuideCommand implements CommandExecutor, TabCompleter {
    ...
    public CustomGuideCommand(SlimefunWeaver plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sub.equals("reload")) {
            if (!sender.hasPermission("slimefunweaver.reload")) {
        ...
        if (sub.equals("export")) {
            if (!sender.hasPermission("slimefunweaver.export")) {
                sender.sendMessage("§c你没有权限执行此命令");
                return true;
            }
